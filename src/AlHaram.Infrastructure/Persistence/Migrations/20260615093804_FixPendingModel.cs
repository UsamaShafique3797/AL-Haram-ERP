        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityNumber = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleNo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryChallans_Godowns_GodownId",
                        column: x => x.GodownId,
                        principalTable: "Godowns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryChallans_SalesInvoices_SalesInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Total = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    ConvertedSalesInvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Quotations_SalesInvoices_ConvertedSalesInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FromGodownId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ToGodownId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransfers_Godowns_FromGodownId",
                        column: x => x.FromGodownId,
                        principalTable: "Godowns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransfers_Godowns_ToGodownId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryChallanLines_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoodsReceivedNotes_Godowns_GodownId",
                        column: x => x.GodownId,
                        principalTable: "Godowns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsReceivedNoteLines_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GoodsReceivedNoteLines_PurchaseOrderLines_PurchaseOrderLineId",
                        column: x => x.PurchaseOrderLineId,
                        principalTable: "PurchaseOrderLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GoodsReceivedNoteLines_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionOrders_ScrapItemId",
                table: "ProductionOrders",
                column: "ScrapItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryChallanLines_UnitId",
                table: "DeliveryChallanLines",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryChallans_GodownId",
                table: "DeliveryChallans",
                column: "GodownId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryChallans_SalesInvoiceId",
                table: "DeliveryChallans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceivedNoteLines_ItemId",
                table: "GoodsReceivedNoteLines",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceivedNoteLines_PurchaseOrderLineId",
                table: "GoodsReceivedNoteLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceivedNotes_GodownId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotations_ConvertedSalesInvoiceId",
                table: "Quotations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransfers_FromGodownId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransfers_ToGodownId",
                table: "StockTransfers",
                column: "ToGodownId");

            migrationBuilder.AddForeignKey(
                name: "FK_ProductionOrders_Items_ScrapItemId",
                table: "ProductionOrders",
                column: "ScrapItemId",
                principalTable: "Items",
                principalColumn: "Id",
